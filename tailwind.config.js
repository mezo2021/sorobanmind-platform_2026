...
export default {
  ...
  theme: {
    extend: {
      fontFamily: {
        display: ['"Baloo 2"', '"Cairo"', 'system-ui', 'sans-serif'],
        body: ['"Cairo"', '"Baloo 2"', 'system-ui', 'sans-serif'],
      },
      colors: {
        purple: {
        ...
        ink: {
          900: '#0a0a1a', 800: '#12122a', 700: '#1a1a3a', 600: '#222250',
          500: '#2a2a5e',
        },
      },
      keyframes: {
        ...
        pulseRing: {
          ...
          '70%': { boxShadow: '0 0 0 18px rgba(168,85,247,0)' },
