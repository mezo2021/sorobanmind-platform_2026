...
// =====================================================================
const LESSON_STORY =
  'في مملكة الأعداد، كان الأبطال الصغار يتعلمون سراً عجيباً: كيف يحوّلون الضرب الكبير إلى خطوات صغيرة سهلة. سأل أحدهم: كم يساوي ٦٢ في ٨؟ فابتسم الحكيم معداد وقال: سنُقسم الرقم إلى عشرات وآحاد، ونضرب كل جزء على حدة. ثم نجمع النتائج على المعداد. هيا نكتشف السر معاً';
