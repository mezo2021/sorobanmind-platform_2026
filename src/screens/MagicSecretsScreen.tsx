...
const SECRETS = [
  ...
  },
  {
    ...
    rule: 'الآحاد: اطرح 2 في كل مرة (مع الدوران عند 10)',
  ...
  },
  {
    ...
    rule: 'الآحاد: صديق العدد الكبير (مكمّله إلى 10)',
    rule2: 'العشرات: أكمل العدّ إلى 9 | المجموع = 9',
    examples: [
  ...
  },
  {
    ...
    rule2: '٢) اضرب البُعدين → الجزء الأيمن | ٣) اطرح بُعد أحدهما من الرقم الآخر → الجزء الأيسر',
    examples: [
      { q: '96 × 97', a: '9312', steps: 'بُعد 96 = 4، بُعد 97 = 3 | الجزء الأيمن: 4 × 3 = 12 | الجزء الأيسر: 96 − 3 = 93 | الناتج: 93 | 12 → 9312' },
      { q: '95 × 98', a: '9310', steps: 'بُعد 95 = 5، بُعد 98 = 2 | الجزء الأيمن: 5 × 2 = 10 | الجزء الأيسر: 95 − 2 = 93 | الناتج: 93 | 10 → 9310' },
      { q: '92 × 97', a: '8924', steps: 'بُعد 92 = 8، بُعد 97 = 3 | الجزء الأيمن: 8 × 3 = 24 | الجزء الأيسر: 92 − 3 = 89 | الناتج: 89 | 24 → 8924' },
    ],
  },
  {
    id: 16,
