...
export const LEVELS: LevelNode[] = [
  ...
  {
    id: 6,
    name: 'Big Friends - Addition',
    nameAr: 'مكملات العشرة — جمع',
    status: 'locked',
    icon: 'Sigma',
    xpRequired: 2200,
  },
  {
    id: 7,
    name: 'Big Friends - Subtraction',
    nameAr: 'مكملات العشرة — طرح',
    status: 'locked',
    icon: 'Sigma',
    xpRequired: 3000,
  },
...
export const QUESTS: Quest[] = [
  {
    ...
    description: 'Complete 10',
    descriptionAr: 'أكمل ١٠ مسائل',
    xpReward: 50,
    progress: 0,
    target: 10,
    icon: 'Swords',
  ...
  },
  {
    ...
    descriptionAr: 'احصل على ٢٠ نقطة',
    xpReward: 80,
    progress: 0,
    target: 20,
    icon: 'Eye',
  ...
  },
  {
    ...
    titleAr: 'سيد الجمع',
    description: '5 additions',
    descriptionAr: '٥ مسائل جمع',
    xpReward: 70,
    progress: 0,
    target: 5,
    icon: 'Plus',
  ...
  },
  {
    ...
    titleAr: 'بطل الطرح',
    description: '5 subtractions',
    descriptionAr: '٥ مسائل طرح',
    xpReward: 70,
    progress: 0,
    target: 5,
    icon: 'Minus',
  ...
  },
  {
    ...
    titleAr: 'محترف الضرب',
    description: '5 multiplications',
    descriptionAr: '٥ مسائل ضرب',
    xpReward: 100,
    progress: 0,
    target: 5,
    icon: 'X',
  ...
  },
  {
    ...
    titleAr: 'خبير القسمة',
    description: '5 divisions',
    descriptionAr: '٥ مسائل قسمة',
    xpReward: 100,
    progress: 0,
    target: 5,
    icon: 'Divide',
  ...
  },
  {
    ...
    descriptionAr: '٥٠ نقطة في الأنزان',
    xpReward: 150,
    progress: 0,
    target: 50,
    icon: 'Eye',
